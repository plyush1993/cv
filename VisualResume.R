...
VisualResume::VisualResume(
  ...
  milestones = data.frame(title = c("Specialist (equivalent to MSc)", "PhD"),
                          ...
                          year = c(2017, 2022)),
  events = data.frame(year = c(2020, 2022.0, 2022.6, 2022.3, 2021),
                      title = c("Plyushchenko I. et al. Analytical Methods (2020)",
                                "Plyushchenko I. et al. Journal of Proteome Research (2022)",
                                "Fedorova E., ... Plyushchenko I. et al. Journal of Chromatography A (2022)",
                                "Ikhalaynen Y., Plyushchenko I. et al. Metabolites (2022)",
                                "Vokuev M., ... Plyushchenko I. et al. Analytical and Bioanalytical Chemistry (2021)")),
