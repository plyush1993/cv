...
p <- p[-which(str_detect(p$title, "Combining Chromatography–Mass Spectrometry")),] # delete duplicated 
...
- MS: SCAN, SIM, MRM, DDA, DIA
- LC: RP, HILIC
- LC-MS (IT-TOF, Shimadzu; Orbitrap Exploris 120, Thermo; QTRAP 3200, Sciex; 6470, Agilent)
...
- xcms, CAMERA, IPO, MSnbase, caret, H2O, keras, ggplot2
...
- GUI software: MetaboAnalyst, MS-DIAL, MZmine, MS-FINDER, SIRIUS+CSI:FingerID, CFM-ID, MetFrag, GNPS
- Vendor Software: LabSolutions (Shimadzu); XCalibur, FreeStyle, Compound Discoverer (Thermo); OpenLab, MassHunter, ChemStation (Agilent)
...
Moscow State University, Faculty of Chemistry", "2018-22",
...
"Agilent advanced training courses at the Analytical centre of Lomonosov Moscow State University on LC, LC-MS", "2016-19"
) %>% 
...
tribble(
  ...
  "Russian Journal of Analytical Chemistry", "Peer Reviewer"
) %>% 
