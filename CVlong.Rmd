...
header-includes:
  - \providecommand{\cvpronouns}[1]{}
  - \providecommand{\cvorcid}[1]{}
  - \providecommand{\cvscholar}[1]{}
  - \providecommand{\cvgooglescholar}[1]{}
  - \providecommand{\cvresearchgate}[1]{}
  - \providecommand{\cvhomepage}[1]{}
---
...
id <- "0000-0003-3883-4695"

works <- as.data.table(orcid_works(id))
...
tribble(
  ~ Award, ~ Year, ~ Place,
  "Institutional Postdoctoral Fellowship", "2025-26", "University of Haifa, Israel", 
...
tribble(
  ~ Job, ~ Year, ~ Where,
  "Postdoctoral Fellow", "2025.01-present", "University of Haifa, Department of Marine Biology",
  ...
  detailed_entries(what = Job, when = Year, where = Where)
```
...
-   LC: RP, HILIC
-   Flash Chromatography: CombiFlash NextGen 300 (Teledyne)
-   Nano LC: Evosep One (Evosep)
-   LC-MS: IT-TOF (Shimadzu); Orbitrap Exploris 120, Orbitrap Q Exactive (Thermo); QTRAP 3200 (Sciex); 6470 (Agilent); timsTOF Pro 2 (Bruker)
...
-   GC-MS: GCMS-QP 2010 with SHS (Shimadzu); 7890 B (Agilent); Trace 1610 & ISQ 7610 with SHS (Thermo)
-   GC-FID: GC-2010 (Shimadzu)
-   MALDI: autoflex maX for Imaging & Dried Drop (Bruker)
...
-   xcms, CAMERA, IPO, MSnbase, MSstats, Biostrings, seqinr, rcdk, caret, H2O, keras, xgboost, ggplot2, dplyr, data.table, RMarkdown, knitr, plotly, Shiny, usethis, devtools, roxygen2, testthat, pkgdown, gert, gitcreds
-   R packages / Shiny tools list: MetCorR [URL](https://plyush1993.github.io/MetCorR/), MetaboCensoR [URL](https://plyush1993.shinyapps.io/metabocensor/), Metabocano [URL](https://plyush1993.shinyapps.io/metabocano/), qry4ms [URL](https://plyush1993.shinyapps.io/qry4ms/), OmniPeak [URL](https://plyush1993.shinyapps.io/omnipeak/)
...
-   GUI software: MetaboAnalyst, MS-DIAL, MZmine, MS-FINDER, Maven, SIRIUS, CFM-ID, MetFrag, GNPS, Open Babel, PathVisio, FragPipe, DIA-NN, Alphapept
...
tribble(
  ...
  "Introduction to Metabolomics 02780958", "2025", "Technion, Faculty of Medicine", "24 hrs",
  ...
  "Basics of Programming in R", "2019", "Bioinformatics Institute, Russia", "6 hrs",
  "Machine Learning", "2019", "Omsk State Technical University, Russia", "7 hrs",
  "Data Analysis in R. Part 2", "2019", "Bioinformatics Institute, Russia", "7 hrs",
 "Data Analysis in R", "2018", "Bioinformatics Institute, Russia", "6 hrs",
...
works <- orcid_works(id)

p <- as.data.table(works)[
  type == "journal-article",
  .(
    title = title,
    journal = journal,
...
tribble(
  ...
  "Unraveling the Complexity of Microalgal EPS: A Multi-Analytical Approach to Polysaccharide Composition and Characterization",
  "ASMS 74th, San Diego, USA", "2026",
  "Heat, Halogens, and Holobionts: LC-MS/MS Insights into Seasonal Metabolite Dynamics in Asparagopsis taxiformis",
  "ASMS 74th, San Diego, USA", "2026",
  "Mass spectrometry reveals metabolic rewiring in Bacillus subtilis following loss of surfactin and plipastatin",
  "ASMS 74th, San Diego, USA", "2026",
  ...
  "Complexation of sulfo-beta-cyclodextrin with fenoterol. Electrophoretic and spectroscopic study", 
...
tribble(
  ...
  "BMC Cancer", "Peer Reviewer",
  "ACS Omega", "Peer Reviewer",
  "Metabolomics", "Peer Reviewer",
  "Journal of Biologically Active Products from Nature", "Peer Reviewer",
  "Communications Medicine", "Peer Reviewer",
  "Discover Artificial Intelligence", "Peer Reviewer",
  "BMC Research Notes", "Peer Reviewer"
) %>% 
